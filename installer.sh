...
# bsd cloudinit
BSDINIT_URL="https://api.github.com/repos/alexyz79/bsd-cloudinit/tarball/$GIT_REF"
...
echo "(
	$PYTHON $BSDINIT_DIR/run.py --verbose --debug --log-file /tmp/cloudinit.log $BSDINIT_SCRIPT_DEBUG_FLAG
